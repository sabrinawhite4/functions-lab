...
function helloWorld() {
  ...
  */
  ...
  stringCapitalizer(sampleString);
  ...
  */
  ...
  //CODE HERE
  function buyingFrogs(maxSpendingGold) {
    return maxSpendingGold / 3 
  ...
  */
  ...
  function buyingFrogs2(maxSpendingGold) {
    return Math.round(maxSpendingGold / 3) 
